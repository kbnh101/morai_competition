...
def listener(arg):
    ...
    while not rospy.is_shutdown():
        ...
        if loaded == 0:
            ...
            #save file's dir
            pkgpath = rospack.get_path('global_path')

            #open file and read
            file = open(pkgpath + "/path_data/"+ "start_intermidate_xy" + ".txt",'r')
            ...
            while(line):
               ...
               temp_pose.header.frame_id = "/map"
                ...
                #x -=302459.942
                #y -=4122635.537
               temp_pose.pose.position.x = x - 302459.942
               temp_pose.pose.position.y = y - 4122635.537
